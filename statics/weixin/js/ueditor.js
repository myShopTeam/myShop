...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:fixedImagePath                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        */
        ,toolbars:[["Bold","Italic","Underline","InsertUnorderedList","InsertOrderedList","InsertImage","RemoveFormat","FontSize","ForeColor","BackColor",'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify']]
        //当鼠标放在工具栏上时显示的tooltip提示,留空支持自动多语言配置，否则以配置值为准
        ,labelMap:{'bold':'','italic':'','underline':'','insertunorderedlist':'','insertorderedlist':'','insertimage':'','removeformat':'','forecolor':'','backcolor':''}
