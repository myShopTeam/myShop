...
<div class="wrap J_check_wrap">
  ...
  <form action="{:U('comment_delete')}" method="post" class="J_ajaxForm">
      ...
      <table width="100%" cellspacing="0">
        <thead>
          <tr>
            ...
            <td align="center">评论者</td>
            <td align="center">评论者IP</td>
...
<div class="show_img" style="position:absolute;margin-top:-30%;margin-left:30%;display:none;z-index:1000;"><img src="" style="max-width:250px;" /></div>
