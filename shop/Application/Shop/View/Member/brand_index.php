...
<div class="wrap J_check_wrap">
  ...
  <form action="{:U('brand_del')}" method="post" class="J_ajaxForm">
      ...
      <table width="100%" cellspacing="0">
        ...
        <tbody>
          <volist name="list" id="vo">
            <tr>
              <td align="center" width="50"><input type="checkbox" value="{$vo.brand_id}" class="J_check" data-yid="J_check_y" data-xid="J_check_x" name="id[]"></td>
              <td align="center"><input type="text" name="listorder[{$vo.brand_id}]" class="input" value="{$vo.listorder}" size="1" /></td>
              <td align="center">{$vo.school_name}</td>
              <td align="center">{$vo.brand_name}</td>
              <td align="center" width="60">
              <a href="{:U('brand_edit',array('brand_id'=>$vo['brand_id']))}">修改</a>|
              <a class="J_ajax_del" href="{:U('brand_del',array('brand_id'=>$vo['brand_id']))}">删除</a>
              </td>
            </tr>
          </volist>
        </tbody>
