...
<div class="wrap J_check_wrap">
  ...
  <form action="{:U('alumni_delete')}" method="post" class="J_ajaxForm">
      ...
      <table width="100%" cellspacing="0">
        ...
        <tbody>
          <volist name="list" id="vo">
            <tr>
              <td align="center" width="50"><input type="checkbox" value="{$vo.alumni_id}" class="J_check" data-yid="J_check_y" data-xid="J_check_x" name="id[]"></td>
              <td align="center"><input type="text" name="listorder[{$vo.alumni_id}]" class="input" value="{$vo.listorder}" size="1" /></td>
              <td align="center">{$vo.alumni_name}</td>
              <td align="center"><if condition="$vo['is_show'] eq 1">显示<else/>不显示</if></td>
              <td align="center" width="60">
              <a href="{:U('alumni_edit',array('aid'=>$vo['alumni_id']))}">修改</a>|
              <a class="J_ajax_del" href="{:U('alumni_delete',array('aid'=>$vo['alumni_id']))}">删除</a>
              </td>
            </tr>
          </volist>
        </tbody>
