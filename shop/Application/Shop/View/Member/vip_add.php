...
<div class="wrap J_check_wrap">
   ...
   <form class="J_ajaxForm" action="{:U('vip_add')}" method="post" id="myform">
   ...
   <table width="100%" class="table_form contentWrap">
        <tbody>
          <tr>
            ...
            <td width="350"><input type="test" name="username" class="input" id="username" placeholder="请输入登录帐号"></td>
              <th width="80">会员昵称</th>
            <td><input type="text" name="nickname" value="" class="input" id="nickname" placeholder="请输入会员昵称"></td>
          </tr>
           <tr>
            <th>登录密码<span class="red">*</span></th>
            <td><input type="password" name="password" value="" class="input" id="password"  placeholder="请输入登录密码"></td>
            <th>确认密码<span class="red">*</span></th>
            <td><input type="password" name="checkPassword" value="" class="input" id="checkPassword"  placeholder="请输入确认密码"></td>
          </tr>
          <tr>
            <th width="80">真实姓名</th>
            <td width="350"><input type="test" name="realname" class="input" id="realname"  placeholder="请输入真实姓名"></td>
              <th width="80">email</th>
            <td><input type="text" name="email" value="" class="input" id="email"  placeholder="请输入邮箱地址"></td>
          </tr>
          <tr>
            <th>生日</th>
            <td><input type="text" name="birthday" class="input length_2 J_date" id="birthday" value="{$_GET.start_uploadtime}" placeholder="请输入生日" style="width: 147px !important;"></td>
              <th>qq</th>
            <td><input type="text" name="qq" value="" class="input" id="qq" placeholder="请输入QQ号"></td>
          </tr>
          <tr>
            <th>家庭电话</th>
