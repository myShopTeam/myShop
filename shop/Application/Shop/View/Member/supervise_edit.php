...
<div class="wrap J_check_wrap">
   ...
   <form class="J_ajaxForm" action="{:U('supervise_edit',array('sid'=>$_GET['sid']))}" method="post" id="myform">
   ...
   <table width="100%" class="table_form contentWrap">
        <tbody>
            ...
            <td><input type="text" class="input" name="school_name" value="{$school_name}" placeholder="例：雷军校友"></td>
          </tr>
        </tbody>
      </table>
   </div>
