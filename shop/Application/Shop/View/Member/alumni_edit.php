...
<div class="wrap J_check_wrap">
   ...
   <form class="J_ajaxForm" action="{:U('alumni_edit',array('aid'=>$_GET['aid']))}" method="post" id="myform">
   <div class="h_a">基本属性</div>
   <div class="table_full">
   <table width="100%" class="table_form contentWrap">
        <tbody>
            <th width="80">分类名称<span class="red">*</span></th>
            <td><input type="test" name="alumni_name" class="input" id="alumni_name" value="{$alumni_name}" placehoder="请输入分类名称"></td>
            </tr>
            <tr>
            <th>显示分类</th>
