...
<div class="wrap J_check_wrap">
  ...
  <table width="100%"  class="table_form">
        <tr>
          <th width="120">关键字：</th>
          <td class="y-bg"><input type="text" name="tag" value="{$data.tag}" class="input" /><input type="hidden" name="_tag" value="{$tag}" /></td>
        </tr>
        <tr>
          <th width="120">附加样式</th>
          <td class="y-bg"><input type="text" name="style" value="{$data.style}" class="input" /> <span>用于前台调用</span></td>
        </tr>
        <tr>
          <th>点击量</th>
