      ...
      <div>
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr >
              <th>跳转链接：</th>
              <td><input type="text" name="info[menuurl]" id="catdir" class="input" value="{$data.menuurl}" style="width:300px;"></td>
            </tr>
            <tr>
              <th>栏目简介：</th>
          ...
          <table width="100%" class="table_form ">
            ...
            <tr style="<if condition="$setting['ishtml'] eq '0' ">display:none</if>" id="tr_domain">
              ...
              <td><input type="text" value="{$data.domain}" size="50" class="input" id="url" name="info[url]">
                <span class="gray"> 域名可为空，格式应该为http://www.lovegq1314.com/</span> </td>
            </tr>
          </table>
        </div>
      </div>
