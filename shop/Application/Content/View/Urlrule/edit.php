...
<div class="wrap J_check_wrap">
  ...
  <div class="prompt_text">
    <p>实现伪静态地址，规则需要自己写，同时也要服务器支持！<br/>
      例如实现伪静态这样的：http://{$_SERVER['HTTP_HOST']}/tag-标签.html ，URL规则是：tag-{$tag}.html|/tag-{$tag}-{$page}.html，服务器上设置，如果是.htaccess则规则是：RewriteRule ^(tag|Tag)-(.*?)\.html$ /Tags/Index/index/tag/$2</p>
  </div>
