...
<div class="wrap J_check_wrap">
 ...
 <form method="post" action="{:U('classlist',array('catid'=>$catid))}">
  ...
  <input type="hidden" value="1" name="search">
    <div class="search_type cc mb10" style="padding:1px;">
      <div class="mb10"> 
        <span class="mr20">
      ...
      <table width="100%">
        ...
        <volist name="data" id="vo">
          <tr>
            ...
            <td><if condition=" $vo['status']==99 "><a href="<?php echo U("Content/edit",array("catid"=>$vo['catid'],"id"=>$vo['id']));?>" target="_blank"><span style="" >{$vo.title}</span></a>
                <else/>
