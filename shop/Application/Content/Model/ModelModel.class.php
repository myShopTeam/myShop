...
class ModelModel extends Model {
    ...
    const mainTableSql = 'Data/Sql/shuipfcms_zhubiao.sql'; //模型主表SQL模板文件
    const sideTablesSql = 'Data/Sql/shuipfcms_zhubiao_data.sql'; //模型副表SQL模板文件
    const modelTablesInsert = 'Data/Sql/shuipfcms_insert.sql'; //可用默认模型字段
    const membershipModelSql = 'Data/Sql/shuipfcms_member.sql'; //会员模型
