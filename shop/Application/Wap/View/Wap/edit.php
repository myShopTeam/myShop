...
<div class="wrap J_check_wrap">
  ...
  <div class="pop_nav">
    <ul class="J_tabs_nav">
      <li class="current"><a href="javascript:;;">[<font color='red'>{$data.catname}</font>]的3G版本基本属性</a></li>
      
    </ul>
  </div>
  <form class="J_ajaxForms" name="myform" id="myform" action="{:U("Wap/edit")}" method="post">
            ...
            <tr id="fmmb">
              ...
              <td><select name="setting[wapcategory_template]" id="wapcategory_template">
                  ...
                  <volist name="tp_category" id="vo">
                    <option value="{$vo}" <if condition="$data['setting']['wapcategory_template'] eq $vo ">selected</if>>{$vo}</option>
                  </volist>
                </select>
            ...
            <tr>
              ...
              <td><select name="setting[waplist_template]" id="wap_template">
                  ...
                  <volist name="tp_list" id="vo">
                    <option value="{$vo}" <if condition="$data['setting']['waplist_template'] eq $vo ">selected</if>>{$vo}</option>
                  </volist>
                </select>
            ...
            <tr  id="plmb">
              ...
              <td><select name="setting[wapshow_template]" id="wapshow_template">
                  ...
                  <volist name="tp_show" id="vo">
                    <option value="{$vo}" <if condition="$data['setting']['wapshow_template'] eq $vo ">selected</if>>{$vo}</option>
                  </volist>
                </select>
									...
									button:[
										{
											name: '去更新缓存',
											callback:function(){
												window.location.href = "{:U('Wap/public_cache')}";
												return true;
											},
											focus: true
										},{
											name: '返回3G版栏目管理页',
											callback:function(){
												window.location.href = "{:U('Wap/index')}";
												return true;
											}
										}
									]
