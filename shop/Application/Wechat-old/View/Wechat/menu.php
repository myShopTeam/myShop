...
<div class="wrap J_check_wrap">
  ...
  <form name="myform" action="{:U('Wechat/menu')}" method="post" class="J_ajaxForm">
    <div class="table_full">
      ...
      <table width="100%">
        <tr>
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[0][url]" class="input length_6" value="{$button[0][url]}"></td>
        </tr>
        <tr>
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[0][sub_button][0][url]" class="input length_6" value="{$button[0][sub_button][0][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[0][sub_button][1][url]" class="input length_6" value="{$button[0][sub_button][1][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[0][sub_button][2][url]" class="input length_6" value="{$button[0][sub_button][2][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[0][sub_button][3][url]" class="input length_6" value="{$button[0][sub_button][3][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[0][sub_button][4][url]" class="input length_6" value="{$button[0][sub_button][4][url]}"></td>
        </tr>
        ...
        <tr>
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[1][url]" class="input length_6" value="{$button[1][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[1][sub_button][0][url]" class="input length_6" value="{$button[1][sub_button][0][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[1][sub_button][1][url]" class="input length_6" value="{$button[1][sub_button][1][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[1][sub_button][2][url]" class="input length_6" value="{$button[1][sub_button][2][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[1][sub_button][3][url]" class="input length_6" value="{$button[1][sub_button][3][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[1][sub_button][4][url]" class="input length_6" value="{$button[1][sub_button][4][url]}"></td>
        </tr>
        ...
        <tr>
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[2][url]" class="input length_6" value="{$button[2][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[2][sub_button][0][url]" class="input length_6" value="{$button[2][sub_button][0][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[2][sub_button][1][url]" class="input length_6" value="{$button[2][sub_button][1][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[2][sub_button][2][url]" class="input length_6" value="{$button[2][sub_button][2][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[2][sub_button][3][url]" class="input length_6" value="{$button[2][sub_button][3][url]}"></td>
        </tr>
        <tr>
          <td width="150" align="center" valign="middle">┗</td>
          <td width="150" align="left" valign="middle">二级菜单：
          ...
          <td align="left" valign="middle">地址/插件：<input type="text" name="button[2][sub_button][4][url]" class="input length_6" value="{$button[2][sub_button][4][url]}"></td>
        </tr>
      </table>
    </div>
    <div class="btn_wrap">
