            ...
            <div class="table_full">
                ...
                <table width="100%" class="table_form contentWrap">
                    <if  condition="$card_type_int == 1">
                        <tbody>
                            <tr>
                                <th width="80">卡号{$card_type_int}<span class="red">*</span></th>
                                ...
                                <td>
                                    <select name="card_type" class="select" id="card_type">
                                        ...
                                        <volist name="card_type_name" id="vo">
                                            <option <eq name="vo.card_name"  value="$card_type">selected</eq> <if condition="$vo.type != 1">disabled</if> value="{$vo.card_name}">{$vo.card_name}</option>
                                        </volist>
                                    </select>
                                </td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select  name="card_type" class="select" id="card_type">
                                        <option ></option>
                                        <volist name="card_type_name" id="vo">
                                            <option <eq name="vo.card_name"  value="$card_type">selected</eq> <if condition="$vo.type != 2">disabled</if> value="{$vo.card_name}">{$vo.card_name}</option>
                                        </volist>
                                    </select>
                                </td>
                                <th>产品名称<span class="red">*</span></th>
                            ...
                            <tr>
                                ...
                                <th width="80">身份证号</th>
                                <td><input value="{$mobile}" type="text" name="cred_num"  class="input" id="email"  placeholder="请输入身份证号"></td>
                            </tr>
                            <tr class="mobile_tr">          
                                <th width="80">手机</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select disabled name="car_type" class="selectType">
                                        ...
                                        <option <if condition="$car_type == '非营运2-5座客车'"> selected="selected"</if> value="1-3座专用车及10吨以上货车">1-3座专用车及10吨以上货车</option>
                                        <option <if condition="$car_type == '1-3座专用车及10吨以上货车'"> selected="selected"</if> value="2-3座罐装车">2-3座罐装车</option>
